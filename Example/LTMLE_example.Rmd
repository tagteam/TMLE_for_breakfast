...
just two periods. The new value 'period' contains the period number. This uses
heaven::splitSeq.
...
example the maximal value is chosen for each period for covariates. 
...
setnames(outcome_dt,"ID","pnr")
setnames(treatment_dt,c("pnr",paste0("treatment_",0:4)))
```
