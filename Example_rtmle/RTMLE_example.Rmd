...
The example has a single baseline variable (Age), Time (of event), Event_Type (0=censor, 1=event, 2=competing risk) and a variable indicating whether they started on treatment or not.
...
x <- rtmle_init(intervals=5,name_id='ID',name_time='period',name_outcome='outcome',
    name_competing='compete',name_censoring='censor',treatment_levels=c('0','1'),
